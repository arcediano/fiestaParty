...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      // Aquí integrarás con Strapi en el futuro
      // Por ahora, simulamos registro y login automático
      ...
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Regístrate para empezar a crear invitaciones increíbles
          </CardDescription>
        </CardHeader>
              ...
              {password && (
                <div className="space-y-2">
                  <div className="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full ${strengthColors[strength - 1] || 'bg-gray-300'} transition-all duration-300`}
